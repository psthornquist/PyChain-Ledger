...
sender_input_value = st.text_input("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_input_value = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_input_value = st.text_input("Amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender=str(sender_input_value), 
        receiver=str(receiver_input_value), 
